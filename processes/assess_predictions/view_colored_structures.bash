...
| xargs voronota-gl -scripts 'spectrum-atoms -adjunct gt -scheme bwr -min-val 0.1 -max-val 0.6' 'spectrum-atoms -adjunct tf -scheme bwr -min-val 0.15 -max-val 0.35' -files
